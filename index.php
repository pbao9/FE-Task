...
<body>
    ...
    <section class="deal-section position-relative my-5" id="deal_section">
    ...
    <section class="about-section my-5" id="about_section">
        <div class="container">
            <div class="row">
    ...
    <section class="card-section my-5" id="card_section">
        <div class="container">
            <div class="row justify-content-evenly">
                <div class="col-lg-3 col-sm-12 bg-light text-black rounded shadow-lg text-center mt-lg-0 mt-sm-3">
    ...
    <section class="partner my-5">
        <div class="container bg-body-tertiary py-5">
            <h4 class="text-center text-uppercase fw-bold title-section">Đối tác hàng đầu</h4>
            <div class="row">
    ...
    <section class="product-section" id="product_section">
        <div class="container">
            <h4 class="text-center text-uppercase fw-bold title-section">Mẫu kính mắt mới</h4>
            <div class="row justify-content-around py-5">
                <!-- Product -->
                <div class="col-lg-2 col-sm-12 shadow p-0 m-0 text-center">
                    <img src="./assets/img/product_1.jpg" alt="" class="img-fluid">
                    <p class="text-uppercase mt-2">Gọng kính Blancy 8470 C3 Bạc</p>
