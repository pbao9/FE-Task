    ...
    <div class="container py-4">
                        ...
                        <div class="col-12 d-flex align-items-center">
                            ...
                            <div class="col px-2">
                                <div class="quantity d-flex align-items-center gap-2">
                                    <input type="text" name="" id="" value="1" class="form-control w-25 shadow-none quantity-left">
                                    <span class="fw-light">x <span class="price-quantity-products fw-bold">250.000đ</span></span>
                                </div>
                            </div>
                            <div class="col px-2">
                                <div class="quantity d-flex align-items-center gap-2">
                                    <input type="text" name="" id="" value="1" class="form-control w-25 shadow-none quantity-right">
                                    <span class="fw-light">x <span class="price-quantity-products fw-bold">250.000đ</span></span>
                                </div>
                            </div>
                        </div>
        ...
        <div class="features-products text-center py-5">
            ...
            <div class="row gap-4 justify-content-evenly">
                <div class="col-lg-2 col-3 shadow rounded p-0">
        ...
        <div class="features-products text-center py-5">
            <p class="text-uppercase fw-bold fs-3">Sản phẩm nỗi bật</p>
            <div class="row gap-4 justify-content-evenly">
                <div class="col-lg-2 col-3 shadow rounded p-0">
                    <img src="./assets/img/product_2.png" class="img-fluid" alt="">
                    <div class="text-uppercase p-2">GỌNG KÍNH EYE PLUS 9812 C11 ĐEN</div>
